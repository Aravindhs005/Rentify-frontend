...
const CreateListing = () => {
  ...
  const handlePost = async (e) => {
    ...
    try {
      ...
      const response = await fetch("https://rentify-backend-git-main-aravindhs-projects-8b4b22dd.vercel.app/properties/create", {
        method: "POST",
        body: listingForm,
      });
        ...
        <form onSubmit={handlePost}>
            ...
            <div className="half">
              <div className="location">
                <input
                  type="text"
                  placeholder="Door No/Apartment No , Name of the Area"
                  name="streetAddress"
...
<button className="submit_btn" type="submit" style={{marginLeft:"35%"}}>
            CREATE YOUR LISTING
          </button>
</div>
